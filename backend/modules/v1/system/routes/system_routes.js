...
router.route('/:id').post(authenticateToken, get_mst_group_by_id)
// .put(authenticateToken, validate_mst_group(true), updateUser).delete(authenticateToken, deleteUser)
